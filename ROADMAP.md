...
- rename package and CLI to `labflow`
- remove old identity from docs and metadata
- lock the stable support matrix

## Phase 1 — Core repo boundaries

- establish package boundaries
- install the Claude Code operating layer
- add generated docs and manifest validation

## Phase 2 — Stable-core implementation

- implement the 6 stable commands
